...
class BIRepository @Inject constructor(
    ...
    fun loadNextPage(address: String, offset: Int): Single<Pair<List<Transaction>, Long>> {
    ...
    companion object {
        private const val FINAL_BALANCE_KEY = "final_balance_key"
        private const val TOTAL_SENT_KEY = "total_sent_key"
        private const val TOTAL_RECEIVED_KEY = "total_received_key"
        private const val NO_OF_TRANSACTIONS_KEY = "no_of_transactions_key"
    }
}